	...
	*/
    ...
    void removeFromInternal(int idx) {
        ...
        if (children[idx].numKeys >= t) {
            ...
            System.out.println("usando PREDECESSOR da chave " + k);
            ...
            System.out.println("usando SUCESSOR da chave " + k);
    ...
    void borrowFromPrev(int idx) {
        ...
        System.out.println("emprestando chave do irmao esquerdo no indice " + idx);
    ...
    void borrowFromNext(int idx) {
        ...
        System.out.println("emprestando chave do irmao direito no indice " + idx);
    ...
    void merge(int idx) {
        ...
        System.out.println("realizando fusao dos nodos " + idx + " e " + (idx + 1));
